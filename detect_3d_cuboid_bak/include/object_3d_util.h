...
bool is_before_clip_plane_camera(Eigen::Vector3d& points_camera, double cam_near_clip=0.15);
void get_3d_bbox_vertex(Eigen::Matrix3d& Kalib, Eigen::Matrix3Xd& points3d, Eigen::Matrix2Xd& points2d, double cam_near_clip=0.15);
...
bool get2dBox(Eigen::Matrix3d& Kalib, Eigen::Matrix3Xd& points3d, Eigen::Matrix2Xi& points2d, Eigen::Vector4d& box_size, int img_width, int img_height, double cam_near_clip=0.15);
void computeboxes(cuboid* raw_cuboid, Eigen::Matrix4d& Twc, Eigen::Matrix3d& Kalib, int img_width, int img_height, double cam_near_clip=0.15);
