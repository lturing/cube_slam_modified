...
extern std::string cuboid_folder;
extern std::string seg_folder;
extern std::string seg_onnx_path;
extern std::string det_onnx_path;
extern std::string det_folder;
extern std::string right_folder;
