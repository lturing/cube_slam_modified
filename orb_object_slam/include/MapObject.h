...
public:
    ...
    std::map<KeyFrame *, Eigen::Vector2d, cmpKeyframe, Eigen::aligned_allocator<std::pair<KeyFrame* const, Eigen::Vector2d >> > velocityhistory; // for offline analysis
    g2o::cuboid pose_Twc_afterba;                                       // latest pose after BA. might have some delay compared to pose_Twc_latestKF

    // std::map<KeyFrame*,g2o::Sim3,std::less<KeyFrame*>, Eigen::aligned_allocator<std::pair<KeyFrame* const, g2o::Sim3>> > KeyFrameAndPose;

    std::map<KeyFrame *, std::pair<g2o::cuboid, bool>, cmpKeyframe, Eigen::aligned_allocator<std::pair<KeyFrame* const, std::pair<g2o::cuboid, bool>>>> allDynamicPoses; // poses/velocity in each keyframe due to movement.  poses/whether_BA
