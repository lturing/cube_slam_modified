...
void LocalMapping::bundle_adjustment_caller()
{
    ...
    {
        //std::cout << "BA Total Object" << std::endl;
...
void LocalMapping::ProcessNewKeyFrame()
{
    ...
    //std::cout << "Mapping: recent buffer pts:  " << mlpRecentAddedMapPoints.size() << "   Frame created pts:  " << newaddRecent << "   Frame associated pts:   " << newaddobservation << std::endl;
