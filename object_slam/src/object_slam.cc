...
#include "object_slam/include/g2o_Object.h"
#include "object_slam/include/Object_landmark.h"
#include "object_slam/include/Tracking_frame.h"
...
{    
    ...
    if (online_detect_mode)
        std::cout << "Online detect object mode !!" << std::endl;
    else
        std::cout << "Offline read object mode !!" << std::endl;
